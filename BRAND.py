...
def fia():    
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/groups/672751520627850/?ref=share');menu()
			elif xd in ['0','00']:
				exit()
			else:
